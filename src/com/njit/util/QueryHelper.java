...
public class QueryHelper {
	...
	public QueryHelper addConditionOther(String condition, Object... params) {
		// 拼接
		if (whereClause.length() == 0) {
			whereClause = " WHERE " + condition;
		} else {
	...
	public QueryHelper addConditionOther(boolean append, String condition, Object... params) {
		if (append) {
			addConditionOther(condition, params);
		}
		return this;
	}
