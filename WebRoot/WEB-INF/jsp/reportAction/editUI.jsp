...
<div id=MainArea>
    ...
    <s:form action="report_edit" method="post" theme="simple" enctype="multipart/form-data">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                ...
                <tr><td>实验报告名称</td>
                    ...
                    <tr><td>所属课程</td>
                        <td><s:textfield  name="task.course.curriculum.name"  readonly="true"  cssClass="InputStyle"/></td>
                    </tr>
                    <tr><td>所属任务</td>
                        <td><s:textfield  name="task.name" readonly="true"  cssClass="InputStyle"/></td>
                    </tr>     
                    <tr><td>实验教师</td>
                        <td><s:textfield  name="user.name" readonly="true" cssClass="InputStyle"/></td>
                    </tr>
