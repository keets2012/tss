...
<!--显示表单内容-->
<div id="MainArea">
    <s:form action="cur_%{id==null?'add':'edit'}">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><s:textfield type="text" name="courseNo" cssClass="InputStyle" /> *</td>
                    </tr>
                    <tr>
                      ...
                      <tr>
                        <td>课程学分</td>
                        <td><s:textfield type="text" name="credit" cssClass="InputStyle"/>*</td>
                    </tr>
                    <tr>
                        <td>课程说明</td>
