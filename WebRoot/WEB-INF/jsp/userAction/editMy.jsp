...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="user_editMyPass?id=%{id}">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr height="50">
						...
						<td><s:password showPassword="false" cssClass="TextField required" name="oldPassword"  /> *</td>
					</tr>
					<tr height="25">
						<td width="150">
							<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/style/blue/images/item_point.gif" />
						...
						<td><s:password showPassword="false" cssClass="TextField required" name="password" /> *</td>
						<td></td>
					</tr>
					<tr height="25">
						<td width="150">
						...
						<td><s:password showPassword="false" cssClass="TextField required" name="password2"  /></td>
						<td></td>
					</tr>
                </table>
            </div>
