				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						...
						<s:if test='#session.user.hasPrivilegeByUrl("/forumManage_list")'>
							...
							<s:a action="topic_edit?id=%{id}&type=1" onClick="return window.confirm('要把本主题设为精华吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_1.gif" />精华</s:a>
							<s:a action="topic_edit?id=%{id}&type=2" onClick="return window.confirm('要把本主题设为置顶吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_2.gif" />置顶</s:a>
							<s:a action="topic_edit?id=%{id}&type=0" onClick="return window.confirm('要把本主题设为普通吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_0.gif" />普通</s:a>
						</s:if>
						</td>
				...
				<table border="0" cellpadding="0" cellspacing="1" width="100%">
					<tr>
						...
						<td align="center">
							<ul class="TopicFunc">
								<!--操作列表-->
								<li class="TopicFuncLi"><s:if test='#session.user.hasPrivilegeByName("/forumManage_list")'>
			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				<tr height="30" class="Tint">
					...
					<td class="no_color_bg">
						<s:textfield type="text" name="title" cssClass="InputStyle" value="回复：%{#topic.title}" style="width:90%"/>
					</td>
				</tr>
				<tr  height="200" class="Tint">
